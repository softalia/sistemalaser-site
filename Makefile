...
serve: build ## Inicia servidor local com rebuild automático em http://localhost:8083
	@node scripts/watch-build.mjs & watcher_pid=$$!; trap 'kill $$watcher_pid' EXIT INT TERM; python3 -m http.server 8083 --directory dist
